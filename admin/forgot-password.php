...
if ( isset($_GET["error"]) )
{
	$errormsg = "Please type in your email correctly.";
}
?>
<!DOCTYPE html>
<html lang="en">
									...
									<div class="col-sm-12 col-xs-12">
										<div class="sp-logo-wrap text-center pa-0 mb-30">
											<a href="index.html">
												...
												<span class="brand-text"><span style="font-size:22px">Create</span></span>
											</a>
										</div>
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Need help with your password?</h3>
											<h6 class="text-center txt-grey nonecase-font">Enter the email you use for <span style="font-size:22px">Create</span>, and we’ll help you create a new password.</h6>
										</div>	
										<div class="form-wrap">
											<form action="login?temp=sent" method="post">
												...
												<div class="form-group text-center">
													<button type="submit" class="btn btn-danger btn-rounded">Reset</button>
												</div>
											</form>
										</div>
									</div>	
